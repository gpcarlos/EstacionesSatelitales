...
\begin{frame}{Estrategias elegidas}
  \begin{center}
    \smartdiagram[bubble diagram]{PSR,
        Backtracking, Local Search, Simulated\\Annealing, Genetic\\Algorithms, PSO}
  \end{center}
\end{frame}
...
\begin{frame}{Estrategias elegidas}
  \begin{center}
    \smartdiagram[bubble diagram]{PSR,
        \color{white}{Backtracking}, \color{white}{Local Search}, \textbf{Simulated}\\\textbf{Annealing}, \textbf{Genetic}\\\textbf{Algorithms}, \color{white}{PSO}}
  \end{center}
\end{frame}
